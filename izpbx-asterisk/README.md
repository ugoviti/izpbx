...
Asterisk 16:  
`docker build --pull --rm --build-arg APP_VER=dev-16 --build-arg APP_DEBUG=1 --build-arg APP_VER_BUILD=1 --build-arg APP_BUILD_COMMIT=fffffff --build-arg APP_BUILD_DATE=$(date +%s) --build-arg ASTERISK_VER=16.15.0 -t izpbx-asterisk:dev-16 .`
